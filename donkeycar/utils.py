...
def load_scaled_image_arr(filename, cfg, cv_preprocessor=None):
    '''
    ...
    try:
        ...
        # TODO
        # add here conversion of images for training
        if cfg.USE_OPENCV:
            img_arr = crop(img_arr, cfg)
            img_arr = cv_preprocessor.run(img_arr)
