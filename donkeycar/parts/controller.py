...
class JoystickController(object):
    ...
    def set_throttle(self, axis_val):
        ...
        # support for R2-pressure (but no backwards behavior)
        # self.throttle = (-1) * (self.throttle_dir * axis_val * self.throttle_scale)
...
class LogitechJoystickController(JoystickController):
    ...
    def init_trigger_maps(self):
        ...
        self.axis_trigger_map = {
            'left_stick_horz': self.set_steering,
            'right_stick_vert': self.set_throttle, # R2_pressure for R2
